...
You are entering DDD mode. This flow is used when features require significant stakeholder communication, focusing on value and understanding over technical details. Read `flows/ddd.md` for the complete workflow reference.

## Overview

DDD emphasizes clear, stakeholder-friendly documentation. It's used when features need explanation to clients, executives, or end-users, focusing on the "why" and "what" from a value perspective. The final output is a "mini-presentation" rather than technical docs.

## Command: $ARGUMENTS

The DDD command helps manage document-driven development.
...
- Ask clarifying questions to understand value proposition and goals.
...
- Design interfaces and data models at a high level.
- Document edge cases and error handling from a functional perspective.
- Update `02-specifications.md` iteratively.
- Wait for explicit "specs approved" before advancing.

### PLAN Phase
- Break down requirements and specs into atomic tasks.
- Identify high-level file changes and dependencies.
- Estimate complexity.
