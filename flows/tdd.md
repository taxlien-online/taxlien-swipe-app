...
You are entering TDD mode. This flow emphasizes exhaustive behavioral analysis through test cases *before* design and implementation. Read `flows/tdd.md` for the complete workflow reference.

## Overview

TDD prioritizes defining correctness through comprehensive test cases first. Design emerges from these cases, ensuring that code directly addresses all required behaviors, including edge cases and error conditions.

## Command: $ARGUMENTS

The TDD command helps manage test-driven development.
