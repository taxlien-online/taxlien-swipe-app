...
### Layer Expanded State

```
+--------------------------------------------------+
|  = Tax parameters   [<] [↑ return to stack]      |
+--------------------------------------------------+
|  +----------------------------------------------+|
|  |  Layer 2: Tax parameters                     ||
|  +----------------------------------------------+|
...
```
+--------------------------------------------------+
|  = Owner: John K.   [<] [5 properties]       [:] |
+--------------------------------------------------+
|                                                  |
|    +--------------------------------------------+|
|    |  1247 Oak St     LIEN    $12,450          ||
|    +--------------------------------------------+|
|    +--------------------------------------------+|
|    |  1249 Oak St     LIEN    $11,890          ||
|    +--------------------------------------------+|
|    +--------------------------------------------+|
|    |  5602 Palm Ave   DEED    $8,200           ||
|    +--------------------------------------------+|
|    +--------------------------------------------+|
|    |  892 Magnolia    LIEN    $15,100          ||
|    +--------------------------------------------+|
|    +--------------------------------------------+|
|    |  3301 Hilltop    DEED    $22,450          ||
|    +--------------------------------------------+|
|                                                  |
|  Total exposure: $70,090                         |
|  Avg ROI: 16.2%                                  |
|                                                  |
+--------------------------------------------------+
|  [Select all] [Add to watchlist] [Investigate]   |
+--------------------------------------------------+
```
...
|  |  [^] Export selection as CSV     ELITE lock  ||
...
|                                                  |
|  +----------------------------------------------+|
|  |  > Show overdue 3+ years             [⌘K]    ||
|  +----------------------------------------------+|
|  |                                              ||
|  |     ████████████░░░░░░░░░░░░░░░░░░░░         ||
|  |     Filtering 847 properties...              ||
|  |                                              ||
|  +----------------------------------------------+|
|                                                  |
+--------------------------------------------------+
...
|       O  .     .        .  O     .               |
|                                                  |
|       (12 properties filtered out)               |
|                                                  |
+--------------------------------------------------+
|  +----------------------------------------------+|
|  |  ✓ Kept 6 deeds with 3+ prior years         ||
|  |                                     [Undo]   ||
|  +----------------------------------------------+|
+--------------------------------------------------+
```
...
|                                                  |
|  +----------------------------------------------+|
|  |  [●] Properties              847 visible     ||
|  |      Color: ROI gradient                     ||
|  +----------------------------------------------+|
|  +----------------------------------------------+|
|  |  [●] Risk heatmap           Enabled          ||
|  |      Opacity: ████████░░ 80%                 ||
|  +----------------------------------------------+|
|  +----------------------------------------------+|
|  |  [○] Owner clusters         Disabled         ||
|  |      Min cluster size: 3                     ||
|  +----------------------------------------------+|
|  +----------------------------------------------+|
|  |  [●] Flood zones            11 in view       ||
|  |      Source: FEMA 2024                       ||
|  +----------------------------------------------+|
|  +----------------------------------------------+|
|  |  [●] Auction venues         8 upcoming       ||
|  |      Show: Next 30 days                      ||
|  +----------------------------------------------+|
|                                                  |
+--------------------------------------------------+
...
|  |  AI ANOMALY DETECTED                         ||
|  |                                              ||
|  |  John K. and Acme LLC appear to be          ||
|  |  related entities:                           ||
|  |                                              ||
|  |  • Both list 1247 Oak St as address         ||
|  |  • Both list 5602 Palm Ave as address       ||
|  |  • Acme LLC formed 2 months after           ||
|  |    John K. acquired first property          ||
|  |                                              ||
|  |  Possible interpretation:                    ||
|  |  Shell company for tax optimization          ||
|  |                                              ||
|  |  [Investigate] [Mark as known] [Dismiss]    ||
|  +----------------------------------------------+|
|                                                  |
+--------------------------------------------------+
```
...
- [x] Notes: Extended mechanics from designlayouts/screens/mechanics-phone.jsx
